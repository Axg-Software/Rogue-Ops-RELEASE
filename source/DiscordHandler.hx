// stole dis from UTP & Project: FTS lololol
// thanks EyeDaleHim :)
package;
...
class DiscordHandler
{
	...
	public static function init():Void
	{
		...
		Discord.Initialize("1320240575139811388", cpp.RawPointer.addressOf(handlers), 1, null);
	...
	static function onReady(request:cpp.RawConstPointer<DiscordUser>):Void
	{
		...
		discordPresence.state = "Rogue Ops";
		discordPresence.details = "In game";
		discordPresence.largeImageKey = "rogueopstitle";
